...
.welcome-text { margin: 0; font-size: 1rem; line-height: 1.55; }
.intro-copy {
  display: flex;
  flex-direction: column;
  gap: .9rem;
...
.welcome-hint { margin: .85rem 0 0; opacity: .86; }
.yt-play-btn {
...
.hero-actions { margin-top: 1rem; display: flex; justify-content: center; }
